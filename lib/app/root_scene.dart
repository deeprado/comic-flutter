...
class RootSceneState extends State<RootScene> {
  ...
  List<Image> _tabImages = [
    Image.asset('assets/images/tab_comic_home_n.png'),
    Image.asset('assets/images/tab_video_home_n.png'),
    Image.asset('assets/images/tab_book_home_n.png'),
    Image.asset('assets/images/tab_mine_n.png'),
  ];
  List<Image> _tabSelectedImages = [
    Image.asset('assets/images/tab_home_comic_p.png'),
    Image.asset('assets/images/tab_video_home_p.png'),
    Image.asset('assets/images/tab_book_home_p.png'),
    Image.asset('assets/images/tab_mine_p.png'),
  ];
